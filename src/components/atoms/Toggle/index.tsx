...
export default function Toggle(props: VoidProps<ToggleProps>) {
	...
	return (
		<Switch {...others}>
			...
			<Switch.Input />
			<Switch.Control class="h-8 w-12 cursor-pointer rounded-full border-2 border-pv-blue-200 bg-pv-blue-100 py-1 transition-all duration-200 data-[checked]:bg-pv-navy-500">
